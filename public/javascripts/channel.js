function Channel(socket, sample_rate, sound_source, current_identifier) {
  ...
  self.equaliser    = new Equaliser(socket, sound_source, sample_rate, current_identifier);
  ...
  function process(input) {
    var output = self.equaliser.process(input);
    return output;
  }
